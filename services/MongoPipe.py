...
class MongoPipe:
    ...
    def pipe_data(self, item):
        ...
        save_item['acceted_answer_id'] = item.accepted_answer_id if 'accepted_answer_id' in item.__dict__ else 'None'
        self.collection.update({'title': item.title}, {'$set': save_item}, upsert=True)
